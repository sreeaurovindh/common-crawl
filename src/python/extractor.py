...
indexed_paths = ['CC-MAIN-2015-27','CC-MAIN-2015-06','CC-MAIN-2015-11','CC-MAIN-2015-14','CC-MAIN-2015-18']
actual_s3_url = 'https://aws-publicdatasets.s3.amazonaws.com/'
index_common_crawl = 'http://index.commoncrawl.org/'
out_folder_name ='indeed-2015-27-may'
...
num_page_request = index_common_crawl + indexed_paths[1] + '-index?url=' +web_page_name + output_numpage_request
output_page_url = index_common_crawl + indexed_paths[1]  + '-index?url=' +web_page_name + output_content
